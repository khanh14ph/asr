...
train_dataset = load_dataset(
    "csv", data_files=config.training_data, split="train", cache_dir=config.cache_dir, sep="|"
)
...
def speech_file_to_array_fn(batch):
    ...
    batch["target_text"] = (
        batch["transcription"] if batch["transcription"] is not None else "[UNK]"
    )
